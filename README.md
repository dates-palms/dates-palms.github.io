...
# כל החישוב (של הפרדת קליפה) האלגוריתמי ועיבוד הנתונים המטאורולוגים הועברו לקוד בצד שרת כדי להתמודד עם חסימות CORS ותקשורת מאובטחת עם מפתח בצד שרת מול השמ"ט 
